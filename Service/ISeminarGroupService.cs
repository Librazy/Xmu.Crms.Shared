 ...
 */
    public interface ISeminarGroupService
    {
        ...
        /// <returns>true/false 是否成功删除</returns>
        bool DeleteSeminarGroupMemberBySeminarGroupId(long seminarGroupId);
        ...
        /// <exception cref="GroupNotFoundException">未找到小组</exception>
        ...
        /// <exception cref="ArgumentException">id格式错误</exception>
        /// <exception cref="SeminarNotFoundException">未找到小组</exception>
        ...
        /// <exception cref="ArgumentException">id格式错误</exception>
        bool DeleteSeminarGroupBySeminarId(long seminarId);
        ...
        /// <returns>long 若创建成功返回该小组的id，失败则返回-1</returns>
        ...
        /// <returns>long 若创建成功返回该小组成员表的id，失败则返回-1</returns>
        ...
        /// <returns>Boolean 若创建成功返回true，失败返回false</returns>
        /// <seealso cref="M:Xmu.Crms.Shared.Service.ISeminarGroupService.DeleteSeminarGroupMemberBySeminarGroupId(System.Int64)"/>
        /// <exception cref="ArgumentException">id格式错误</exception>
        bool DeleteSeminarGroupByGroupId(long seminarGroupId);
        ...
        /// </summary>
        /// <param name="groupId">小组id</param>
        /// <returns>true/false 返回取消话题是否成功</returns>
        /// <exception cref="ArgumentException">id格式错误</exception>
        /// <exception cref="GroupNotFoundException">未找到小组</exception>
        ...
        /// <param name="groupId">小组id</param>
        /// <param name="userId">学生id</param>
        /// <returns>true/false 返回成为组长是否成功</returns>
        /// <exception cref="ArgumentException">id格式错误</exception>
        /// <exception cref="UserNotFoundException">不存在该学生</exception>
        /// <exception cref="GroupNotFoundException">未找到小组</exception>
        /// <exception cref="InvalidOperationException">已经有组长了</exception>
        bool AssignLeaderById(long groupId, long userId);
        ...
        /// <param name="groupId">小组id</param>
        /// <param name="userId">学生id</param>
        /// <returns>true/false 返回组成辞职是否成功</returns>
        /// <exception cref="ArgumentException">id格式错误</exception>
        /// <exception cref="UserNotFoundException">不存在该学生</exception>
        /// <exception cref="GroupNotFoundException">未找到小组</exception>
        /// <exception cref="InvalidOperationException">学生不是组长</exception>
        bool ResignLeaderById(long groupId, long userId);
    }
}